    ...
    <div className="flex h-screen">
      ...
      <div className="ml-[16.67%] w-5/6 bg-[#f8fafe] p-10 -mb-24 h-screen max-[320px]:w-full max-[320px]:ml-0">
        ...
        <div className="w-full h-auto flex justify-between items-center mb-4 max-[320px]:flex-wrap max-[320px]:justify-center">
          <div className="flex items-center space-x-4 max-[320px]:flex-wrap max-[320px]:justify-center max-[320px]:sppace-x-0">
            ...
            {/* Sort/Filter Options */}
            <select className="border border-gray-300 bg-white rounded py-2 px-3 max-[320px]:w-1/3 max-[320px]:px-0">
              <option value="">Sort by</option>
            </select>
            <select className="border border-gray-300 bg-white rounded py-2 px-3 w-1/3 max-[320px]:px-0">
        ...
        {/* Middle Container */}
        <div className="grid grid-cols-4 gap-4 justify-items-center max-[320px]:grid-cols-2">
      ...
      {showOverlay && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="relative bg-white p-8 w-2/4 h-1/3 flex flex-col justify-center rounded-lg shadow-lg space-y-4 max-[320px]:w-full">

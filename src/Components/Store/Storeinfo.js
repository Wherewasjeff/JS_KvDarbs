...
const StoreInfo = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://my-laravel-app.test/api/store', data);
  ...
  return (
      <div className="flex h-screen">
        {/* Sidebar */}
        <Sidebar employeeName={user.name} />

        {/* Main Content */}
        <div className="w-5/6 bg-[#f8fafe] ml-[16.47%] p-10 max-[320px]:w-screen max-[320px]:p-2 flex justify-center items-center max-[320px]:ml-0">
          {/* Progress Bar */}
          ...
          <form onSubmit={handleSubmit}
                className="space-y-4 max-w-md mx-auto mt-10 bg-white shadow-2xl p-8 rounded-lg shadow-gray-500 max-[320px]:p-4">
            ...
            <div className="border-2 border-[#DF9677] p-4 rounded-lg flex justify-center max-[320px]:p-2">

...
function Register() {
  ...
  return (
      <div className="flex h-screen bg-[#f8fafe] overflow-hidden max-[320px]:flex-col">
        ...
        />
        <div className="w-1/2 bg-[#f8fafe] flex justify-center items-center relative max-[320px]:absolute max-[320px]:w-full max-[320px]:h-full max-[320px]:opacity-50">
          <div className="w-full h-full bg-[#f5dfd6] flex justify-center items-center absolute rotate-45 shift-right"></div>
          <div className="w-full h-full bg-[#ecc0ad] flex justify-center items-center absolute rotate-45 right-36 top-2 shift-left"></div>
          <div className="w-full h-full bg-[#DF9677] flex justify-center items-center absolute rotate-45 right-80 top-2 shift-diagonal"></div>
        </div>
        ...
        <div className="w-1/2 flex justify-center items-center relative max-[320px]:w-full max-[320px]:h-screen">
          ...
          <div className="p-10 w-1/2 ml-20 max-[320px]:w-11/12 max-[320px]:ml-0 max-[320px]:bg-[#f8fafe] rounded-lg max-[320px]:p-5">
        ...
        <div className="absolute top-[3%] right-[2%] fall-animation">
          ...
          {dropdownOpen && (
              <ul className="absolute right-0 mt-2 bg-white border border-gray-300 rounded shadow-lg w-[150px]">
                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer">Latvian</li>
                <li className="py-2 px-4 hover:bg-gray-100 cursor-pointer">English</li>
              </ul>
          )}
        </div>
      </div>
